...
function getSoulDominionBonuses(soulCount) {
  ...
  return {
    bonusMaxHealth: Math.min(95, Math.round(souls * 0.22 + Math.max(0, souls - 220) * 0.05)),
    moveSpeedMultiplier: 1 + Math.min(0.12, souls * 0.00012),
    jumpVelocityMultiplier: 1 + Math.min(0.09, souls * 0.00009),
    damageReductionBonus: Math.min(0.1, souls * 0.0001),
    xpGainMultiplier: 1 + Math.min(0.15, souls * 0.00015),
    soulMagnetMultiplier: 1 + Math.min(0.35, souls * 0.00035),
    soulHealMultiplier: 1 + Math.min(0.22, souls * 0.00022),
    regainPerSecondBonus: Math.min(1.25, souls * 0.00125),
    fireballDamageMultiplier: 1 + Math.min(0.7, souls * 0.0007),
    fireballExplosionRadiusMultiplier: 1 + Math.min(0.18, souls * 0.00018),
    fireballExplosionDamageMultiplier: 1 + Math.min(0.16, souls * 0.00016),
    fireballCritChanceBonus: Math.min(0.08, souls * 0.00008),
    fireballCritMultiplierBonus: Math.min(0.24, souls * 0.00024),
    fireballRangeMultiplier: 1 + Math.min(0.12, souls * 0.00012),
    fireballSpeedMultiplier: 1 + Math.min(0.1, souls * 0.0001),
    attackDurationMultiplier: 1 - Math.min(0.16, souls * 0.00016),
  };
}
...
function buildUpgradeCatalog() {
  const families = [
    ...
    createFamilyDefinition({
      ...
      category: 'fireball',
      art: 'explosion',
      values: [0.04, 0.05, 0.07, 0.09, 0.12, 0.15],
    ...
    createFamilyDefinition({
      ...
      category: 'fireball',
      art: 'wind',
      values: [0.04, 0.05, 0.07, 0.09, 0.11, 0.14],
    ...
    createFamilyDefinition({
      ...
      category: 'fireball',
      art: 'crit',
      values: [0.02, 0.025, 0.03, 0.035, 0.04, 0.05],
    ...
    createFamilyDefinition({
      ...
      category: 'fireball',
      art: 'crit',
      values: [0.08, 0.1, 0.12, 0.14, 0.17, 0.2],
    ...
    createFamilyDefinition({
      ...
      category: 'movement',
      art: 'boots',
      values: [0.03, 0.04, 0.05, 0.06, 0.08, 0.1],
    ...
    createFamilyDefinition({
      ...
      category: 'survival',
      art: 'heart',
      values: [0.05, 0.08, 0.12, 0.18, 0.25, 0.35],
